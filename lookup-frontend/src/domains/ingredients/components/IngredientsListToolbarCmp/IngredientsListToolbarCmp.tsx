...
import "./IngredientsListToolbarCmp.scss";
...
const IngredientsListToolbarCmp: FC = () => {
  ...
  return (
    <div className="ingredients-list-toolbar-component">
      <Toolbar className="ingredients-list-toolbar-wrapper">
        <div className="ingredients-list-toolbar-filter-sort">
          <LabelIconButtonCmp
            label="Filters"
            icon={<FilterAlt />}
            iconPosition="start"
        ...
        <div className="ingredients-list-toolbar-search-add">
          <SearchBarCmp />
          <BasicModalCmp
      ...
      <Stack spacing={1} direction="row" useFlexGap flexWrap="wrap" className="ingredients-list-toolbar-chips">
        {chipData.map((chip) => {
          return (
            <ChipButtonCmp
              key={chip.key}
...
export default IngredientsListToolbarCmp;
